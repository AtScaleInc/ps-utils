...
case $state in
  ...
  atscale-deploy-model)
    _values 'params' --logfile --output --verbose --connection-file --atscale-connection-name --catalog-xml-file --repository-id --repository-name --tableau-servers --insecure
    ;;
