...
_atscale_utils_complete() {
  ...
  case "$op" in
    ...
    atscale-deploy-model)
      params="--logfile --output --verbose --connection-file --atscale-connection-name --catalog-xml-file --repository-id --repository-name --tableau-servers --insecure"
      ;;
