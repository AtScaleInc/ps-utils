...
import type { QueryNameCollision } from "../model-query-name-compatibility.js";
...
export class AtScaleListModelErrorsOperation extends Operation<Params> {
  ...
  private async validate(
    ...
    let queryNameCollisions: QueryNameCollision[] = [];
    if (skipStructural) {
      ...
      ({ collisions: queryNameCollisions } = detectLevelAttributeQueryNameCollisions(
